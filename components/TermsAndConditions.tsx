      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-zinc dark:prose-invert max-w-none space-y-8 text-zinc-600 dark:text-zinc-400">
          <section>
            ...
            <p>
              By accessing or using the Today mobile application ("App") and
          ...
          <section>
            ...
            <p>
              You are responsible for your use of the App and for any content
              you post or store within it. You agree not to use the App for any
          ...
          <section>
            ...
            <p>
              ...
              exclusive property of Today and are protected by international
          ...
          <section>
            ...
            <p>
              Today is provided "as is" and "as available" without any
          ...
          <section>
            ...
            <p>
              ...
              on this page. Your continued use of the App after such changes
          ...
          <section>
            ...
            <p className="mb-4">
              Today offers auto-renewable subscriptions. By subscribing, you
            ...
            <ul className="list-disc ml-6 space-y-2">
              ...
              <li>
                <strong>Account Charging:</strong> Your account will be charged
                for renewal within 24 hours prior to the end of the current
                period.
              </li>
              <li>
                <strong>Management:</strong> You can manage or turn off
                auto-renew in your Apple ID Account Settings at any time after
                purchase.
              </li>
              <li>
                <strong>Cancellations:</strong> No cancellation of the current
                subscription is allowed during the active subscription period.
              </li>
            </ul>
          </section>
        </div>
